    ...
    <div class="page-header">
        <h3>
            ...
            <div class="pull-right">
                ...
                <a class="btn btn-small btn-danger delete" href="#" data-toggle="modal" data-target="#confirmDelete" data-link="{{ URL::to('returns/delete') }}"
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        oTable = $('#requests').dataTable( {
            ...
            "bProcessing": true,
                    "bServerSide": true,
            "sAjaxSource": "{{ URL::to('admin/returns/data/requested') }}",
